# Mini-Project-User-Configurable-Medicine-Reminder-System
                Designed and implemented a User-Configurable Medicine Reminder System using the LPC2148 ARM7 
        microcontroller and Embedded C. The system displays real-time clock data on an LCD, allows users to 
        set medicine schedules via keypad, and generates alerts through a buzzer when scheduled times match RTC time.
...
![MEDICINE_MENU](image/MEDICINE_MENU.png)
...
****DUPLICATE MEDICINE TIME TEST CASE****
